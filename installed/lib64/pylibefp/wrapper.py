    ...
    for pth in fragpath.split(os.pathsep):
        if pth == 'LIBRARY':
            for lst in [paths, library_paths]:
                for spth in '/scratch/gilbreth/paulsk/backup/pyMLMM/libefp2/installed/share/libefp/fraglib;/scratch/gilbreth/paulsk/backup/pyMLMM/libefp2/installed/share/libefp/fraglib/databases'.split(';'):
                    lst.append(spth)
                ...
                for spth in ''.split(';'):
                    lst.append(str((Path('/scratch/gilbreth/paulsk/backup/pyMLMM/libefp2/python') / '..' / spth).resolve()))
        else:
